      ...
      return db.sequelize.transaction((t: Transaction) => {
        return db.Comment
          ...
          .then((comment: CommentInstance) => {
            ...
            throwError(comment.get('user') != authUser.id, `Unauthorize! You can only edit comments by yourself!`);
            input.user = authUser.id;
      ...
      return db.sequelize.transaction((t: Transaction) => {
        return db.Comment
          ...
          .then((comment: CommentInstance) => {
            ...
            throwError(comment.get('author') != authUser.id, `Unauthorize! You can only delete comments by yourself!`);
